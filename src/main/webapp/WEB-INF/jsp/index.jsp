...
<div id="mainbody" class="colonneMain">
    ...
    <main id="mainContant">
        ...
        <p>Bonjour est bienvenu sur mon blog. Ce blog a été conçu pour être une vitre de mes activités .Les activités
            seront de type informatique principalement mais pas que. Sur site vous avez mes coordonnées ainsi que mon
        ...
        <p>
            <a href="#mainContant">
                <button class="bpRetour">
                    <img src="../../static/image/icon/chevrons-up.svg" alt="retour en haut de la page">
                </button>
            </a>
