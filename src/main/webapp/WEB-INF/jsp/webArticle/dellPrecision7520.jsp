    ...
    <div id="mainbody" class="colonneMain">
        ...
        <main id="mainContant">
            <article>
                ...
                <p>
                    <img src="/image/article/dellPrecision_7520.png" alt="image du dell precision" />
                    <span class="enteteParagraphe">
                <a href="https://ark.intel.com/content/www/fr/fr/ark/products/88970/intel-core-i7-6820hq-processor-8m-cache-up-to-3-60-ghz.html" target="_blank">Processeurs </a>haut de gamme:&nbsp;</span> Nous savons que vous vous
                    occupez de projets de grande envergure. C’est pourquoi nous vous proposons les meilleurs processeurs disponibles. La station de travail mobile Dell&nbsp;Precision&nbsp;7520 offre une puissance de traitement illimitée avec les performances
                    exceptionnelles des processeurs Intel®&nbsp;Core™&nbsp;i5,&nbsp;i7 de 7e&nbsp;génération et des processeurs Intel®&nbsp;Xeon®. </p>

                <p><span class="enteteParagraphe">Des détails de génie:&nbsp;</span> La conception haut de gamme innovante offre jusqu’à quatre options d’affichage d’une qualité irréprochable allant jusqu’à la résolution Ultra HD avec une couverture Adobe
                    RVB complète et 8 millions de pixels. Avec des détails aussi éclatants, vous profitez d’une superbe définition pour tout voir nettement.</p>

                <p><span class="enteteParagraphe">Graphiques hautes performances:&nbsp;</span> Choix entre 2 cartes graphiques Radeon Pro™ WX de qualité professionnelle et 2 cartes graphiques NVIDIA Quadro® avec jusqu’à 4 Go de mémoire graphique. La mémoire
                    DDR4 très haut débit à 2 400 MHz et 2 667 MHz vous permet d’exécuter des tâches de rendu 3D complexes et d’autres tâches graphiques.</p>

                <p><span class="enteteParagraphe">Une fiabilité optimale:&nbsp;</span> processus de test, d’optimisation et de certification basés sur des applications logicielles professionnelles et options de support avec délais d’intervention à la pointe
                    du secteur.</p>

                <p><span class="enteteParagraphe">Prise en charge de l’affichage 8k :&nbsp;</span> les stations de travail Dell Precision 7520 et 7720 sont les premières à être équipées de la technologie DisplayPort 1.4, qui prend en charge la résolution
